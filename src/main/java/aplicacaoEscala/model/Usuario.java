...
public class Usuario implements Serializable {
	 ...
	 * result = prime * result + ((login == null) ? 0 : login.hashCode()); return
	 * result; }
	 */
	 ...
	 * false; Usuario other = (Usuario) obj; if (login == null) { if (other.login !=
	 * null) return false; } else if (!login.equals(other.login)) return false;
	 * return true; }
	 * 
	 */
